    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/deaprtment/scholarships/create").hasRole("ADMIN")
                        .requestMatchers("/deaprtment/scholarships/status").hasRole("ADMIN")
                        .requestMatchers("/deaprtment/idcard/generate/{studentId}").hasRole("ADMIN")
                        .requestMatchers("/department/getInfo/**").hasAnyRole("STUDENT","ADMIN").anyRequest().authenticated())
